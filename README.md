...
```bash
# Generate Shell models from an OpenAPI spec
cdd-sh from_openapi to_sdk -i spec.json -o src/models

# Generate an OpenAPI spec from your Shell code
cdd-sh to_openapi -f src/models -o openapi.json
```
