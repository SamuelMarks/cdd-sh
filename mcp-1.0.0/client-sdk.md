...
| Native MCP Tool Adapter | `[x]` , `[x]` | `[x]` , `[x]` | E.g., `client.mcp.get_tools()` mapping SDK methods |
| Native MCP Resource Adapter | `[x]` , `[x]` | `[x]` , `[x]` | Exposes internal state/docs as MCP resources |
| LLM Execution Router | `[x]` , `[x]` | `[x]` , `[x]` | Native execution via `client.mcp.execute_tool(name, args)` |
